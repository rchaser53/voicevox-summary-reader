...
import { processUrl, processUrls } from './lib/website-summarizer-core';
...
let summaryLength: string = 'medium';
let useConfigFile: boolean = configArg !== undefined;
...
if (useConfigFile) {
  ...
  outputDir = websites.output_dir || 'website_summaries';
  summaryLength = websites.summary_length || 'medium';
  
  console.log(`📁 出力ディレクトリ: ${outputDir}`);
  console.log(`📏 要約の長さ: ${summaryLength}`);
  console.log(`🔢 処理するURL数: ${websites.urls.length}`);
